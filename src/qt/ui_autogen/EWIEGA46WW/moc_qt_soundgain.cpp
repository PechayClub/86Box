...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SoundGain_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SoundGain_t qt_meta_stringdata_SoundGain = {
    {
QT_MOC_LITERAL(0, 0, 9), // "SoundGain"
QT_MOC_LITERAL(1, 10, 30), // "on_verticalSlider_valueChanged"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 5), // "value"
QT_MOC_LITERAL(4, 48, 21) // "on_SoundGain_rejected"
...
QT_INIT_METAOBJECT const QMetaObject SoundGain::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_SoundGain.data,
